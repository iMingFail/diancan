...
class Core extends WeModuleSite
{
    ...
    public $table_yuyue = 'weisrc_dish_yuyue';
    ...
    public $table_areas = "weisrc_dish_areas";
        ...
        if ($_W['role'] == 'operator') {
            ...
            $navemenu[0] = array(
                ...
                'items' => array(
                    ...
                    // 8 => $this->createMainMenu('会员管理 ', $do, 'allfans', ''),
...
//        $cur_color = ' style="color:#d9534f;" ';
        ...
        $navemenu[] = array(
            ...
            'items' => array(
                ...
                5 => $this->createSubMenu('配送区域 ', $do, 'dispatchareas', 'fa-angle-right', $cur_color, $storeid),
            )
        );
        $cur_color = '#8d8d8d';
        $navemenu[] = array(
            ...
            'items' => array(
                ...
                3 => $this->createSubMenu('预订管理 ', $do, 'reservation', 'fa-angle-right', $cur_color, $storeid),
                 4 => $this->createSubMenu('语言管理 ', $do, 'language', 'fa-angle-right', $cur_color, $storeid),
        ...
        $cur_color = '#8d8d8d';
        $navemenu[] = array(
            'title' => '<icon style="color:' . $cur_color . ';" class="fa fa-money"></icon>  支付设置',
            'items' => array(
                // 0 => $this->createSubMenu('提现管理 ', $do, 'businesscenter', 'fa-angle-right', $cur_color, $storeid),
                1 => $this->createSubMenu('商户配置 ', $do, 'businesssetting', 'fa-angle-right', $cur_color, $storeid)
            ),
        );
