...
if (checksubmit('submit')) {
    ...
    $data = array(
        ...
        'xl_shopNum' => trim($_GPC['xl_shopNum']),
        'xl_terminalNum' => trim($_GPC['xl_terminalNum']),
        'xl_code' => trim($_GPC['xl_code']),
        'xl_key' => trim($_GPC['xl_key']),
        'is_jueqi_ymf' => trim($_GPC['is_jueqi_ymf'])
    );
