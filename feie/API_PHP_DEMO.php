...
define('USER', '1136033183@qq.com');	//*必填*：飞鹅云后台注册账号
define('UKEY', 'SmcUud5YcAp3wCDH');	//*必填*: 飞鹅云注册账号后生成的UKEY
define('SN', '917512011');	    //*必填*：打印机编号，必须要在管理后台里添加打印机或调用API接口添加之后，才能调用API
