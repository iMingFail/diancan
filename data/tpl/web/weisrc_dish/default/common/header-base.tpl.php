...
<head>
	...
	<title>商户后台-<?php  if(isset($title)) $_W['page']['title'] = $title?><?php  if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?> - <?php  } ?><?php  if(empty($_W['page']['copyright']['sitename'])) { ?><?php  } else { ?><?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
...
<body style="background-color: #eee;background-image: url(http://16949462.vip2.v-ct.com/public/images/login_bg.jpg);">
