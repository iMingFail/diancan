...
<head>
	...
	<link href="./resource/css/bootstrap.min.css?v=20170706" rel="stylesheet">
	<link href="./resource/css/common.css?v=20170706" rel="stylesheet">
	<script type="text/javascript">
	if(navigator.appName == 'Microsoft Internet Explorer'){
		if(navigator.userAgent.indexOf("MSIE 5.0")>0 || navigator.userAgent.indexOf("MSIE 6.0")>0 || navigator.userAgent.indexOf("MSIE 7.0")>0) {
			alert('您使用的 IE 浏览器版本过低, 推荐使用 Chrome 浏览器或 IE8 及以上版本浏览器.1111');
		}
	}
	window.sysinfo = {
	...
	<script>var require = { urlArgs: 'v=20170706' };</script>
	<script type="text/javascript" src="./resource/js/lib/jquery-1.11.1.min.js?v=20170706"></script>
	<script type="text/javascript" src="./resource/js/lib/bootstrap.min.js?v=20170706"></script>
	<script type="text/javascript" src="./resource/js/app/util.js?v=20170706"></script>
	<script type="text/javascript" src="./resource/js/app/common.min.js?v=20170706"></script>
	<script type="text/javascript" src="./resource/js/require.js?v=20170706"></script>
</head>
<body>
