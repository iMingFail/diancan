			...
			<tr ng-repeat="module in module_list">
				...
				<td class="text-left">
					<div class="link-group">
						...
						<a href="<?php  echo url('system/module/module_detail')?>&name={{ module.name }}&show=upgrade&account_type=<?php echo ACCOUNT_TYPE;?>" class="color-red del" ng-if="module.upgrade && module.from == 'cloud' && isFounder == 1">升级</a>
						<a href="<?php  echo url('system/module/module_detail')?>&name={{ module.name }}&account_type=<?php echo ACCOUNT_TYPE;?>" ng-if="isFounder == 1">管理设置</a>
...
<div class="js-system-module-detail" ng-controller="detailCtrl" ng-cloak>
	...
	<table class="table we7-table table-hover vertical-middle" ng-show="show == 'upgrade'" ng-if="isFounder == 1 && upgradeInfo.from == 'local'">
		...
		<tr>
			...
			<td class="text-right">
				<a href="<?php  echo url('system/module/upgrade')?>module_name={{ moduleinfo.name }}&account_type=<?php echo ACCOUNT_TYPE;?>" class="btn btn-danger">升级</a>
			</td>
		</tr>
	</table>
