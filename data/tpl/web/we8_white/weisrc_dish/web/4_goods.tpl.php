                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            ...
                            <a class="btn btn-warning btn-sm" href="<?php  echo $this->createWebUrl('goods', array('id' =>  $item['id'], 'op' => 'restore', 'storeid' => $storeid))?>" data-toggle="tooltip" title="门店管理" data-content="商品管理,订单管理" >还原</a>
                            <?php  } ?>
                        </td>
                    </tr>
                    <?php  } } ?>
