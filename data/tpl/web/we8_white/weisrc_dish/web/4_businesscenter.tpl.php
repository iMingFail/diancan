        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
             ...
             <!--    <div class="form-group wechat" <?php  if($store['business_type']==2) { ?>style="display:none;"<?php  } ?>>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label" style="color:#f00;">微信支付</label>
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" name="is_jueqi_ymf" value="1" <?php  if($store['is_jueqi_ymf']==1 || empty($store)) { ?>checked<?php  } ?>>显示
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="is_jueqi_ymf" value="0" <?php  if(isset($store['is_jueqi_ymf']) && empty($store['is_jueqi_ymf'])) { ?>checked<?php  } ?>>隐藏</label>
                    </div>
                </div>
                <!-- <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">机构号</label>
                    <div class="col-sm-9">
                        <input type="text" name="xl_code" class="form-control" value="<?php  echo $store['xl_code'];?>" placeholder=""/>

                    </div>
                </div>
                 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">商铺编号</label>
                    <div class="col-sm-9">
                        <input type="text" name="xl_shopNum" class="form-control" value="<?php  echo $store['xl_shopNum'];?>" placeholder=""/>

                    </div>
                </div>

                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">终端编号</label>
                    <div class="col-sm-9">
                        <input type="text" name="xl_terminalNum" class="form-control" value="<?php  echo $store['xl_terminalNum'];?>" placeholder=""/>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="xl_key" class="form-control" value="<?php  echo $store['xl_key'];?>" placeholder=""/>
                        <div class="help-block">
