    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">简体中文分类名称</label>
                    <div class="col-sm-9 input-group">
                        <input type="text" name="catename" class="form-control" value="<?php  echo $category['name'];?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">英文分类名称</label>
                    <div class="col-sm-9 input-group">
                        <input type="text" name="en_name" class="form-control" value="<?php  echo $category['en_name'];?>" />
                    </div>
                </div>
                 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">日文分类名称</label>
                    <div class="col-sm-9 input-group">
                        <input type="text" name="jp_name" class="form-control" value="<?php  echo $category['jp_name'];?>" />
                    </div>
                </div>
                 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">韩文分类名称</label>
                    <div class="col-sm-9 input-group">
                        <input type="text" name="hw_name" class="form-control" value="<?php  echo $category['hw_name'];?>" />
                    </div>
                </div>
                 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">繁体中文分类名称</label>
                    <div class="col-sm-9 input-group">
                        <input type="text" name="ft_name" class="form-control" value="<?php  echo $category['ft_name'];?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">PY分类名称</label>
                    <div class="col-sm-9 input-group">
                        <input type="text" name="py_name" class="form-control" value="<?php  echo $category['py_name'];?>" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php  echo tpl_form_field_image('pic', $category['pic'])?>
                    </div>
                </div>
                <div class="form-group">
...
<div class="main">
    ...
    <div class="panel panel-default" id="uploaddata" style="display: none;">
        <div class="panel-body">
            <form action="./index.php" method="post" class="navbar-form navbar-left" onsubmit="return formcheck(this)"  enctype="multipart/form-data">
