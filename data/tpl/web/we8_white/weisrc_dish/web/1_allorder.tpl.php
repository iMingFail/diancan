                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php  } ?>
                                <?php  } ?>
                                <?php  if($item['dining_mode']==5) { ?><span class="label label-info" title="收银" style="background-color: #d43f3a;border-color: #fee188;"><i class="fa fa-calendar"> 排队</i></span><?php  } ?>
                            ...
                            <td style="text-align:left;">
                                ...
                                <?php  if($item['dining_mode']==2) { ?>
                                <!-- <a class="btn btn-warning btn-sm btn_table_show" href="javascript:void(0);" title="配送" data-value="<?php  echo $item['id'];?>">配送</a> -->
                                <?php  } ?>
