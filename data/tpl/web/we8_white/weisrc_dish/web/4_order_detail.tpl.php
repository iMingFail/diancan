                    ...
                    <div class="panel-body clearfix">
                        <form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
                            <div class="col-xs-12 col-sm-6 order-infos">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-xs-9 col-sm-9 form-control-static">
                                        <b><span class="text-currency big"><?php  if($item['dining_mode']==1) { ?>堂点<?php  } ?>
                                            ...
                                            <?php  if($item['dining_mode']==5) { ?>排队<?php  } ?>
                                ...
                                <div class="form-group clearfix">
                                    <label class="col-xs-3 col-sm-3 control-label">是否抽烟:</label>
                                    <div class="col-xs-9 col-sm-9 form-control-static">
                                       是
                                    </div>
                                </div>
                                <?php  } ?>
                                <?php  if($item['smoking'] == 2 ) { ?>
                                <div class="form-group clearfix">
                                    <label class="col-xs-3 col-sm-3 control-label">是否抽烟:</label>
                                    <div class="col-xs-9 col-sm-9 form-control-static">
                                       否
            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php  if($item['ispay']==0) { ?>
                            <a class="btn btn-warning btn-sm btn_table_show" href="javascript:void(0);" title="退菜" data-value="<?php  echo $row['goodsid'];?>">退菜</a>
                            <?php  } ?>
                        </td>
                    </tr>
                    <?php  } } ?>
