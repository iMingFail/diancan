                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-lg-2 col-xs-12">
                        <select name="dining_mode" class="form-control">
                            ...
                            <option value="5" <?php  if($_GPC['dining_mode'] == 5) { ?> selected="selected" <?php  } ?>>排队</option>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php  } ?>
                                <?php  } ?>
                                <?php  if($item['dining_mode']==5) { ?><span class="label label-info" title="排队" style="background-color: #d43f3a;border-color: #fee188;"><i class="fa fa-calendar"> 排队</i></span><?php  } ?>
                            ...
                            <td>
                                ...
                                <?php  if($item['status'] == -2) { ?><span class="label label-danger">预支付</span><?php  } ?>
                            </td>
                            <td>
                                <?php  if($item['paytype']) { ?>
...
<div class="shop-preview col-xs-12 col-sm-9 col-lg-10">
    <div class="text-left alert alert-info">
        <input type="button" class="btn btn-success" name="btn_printall" value="打印订单" />
            ...
            if (confirm("确认要打印选择的订单?")) {
              ...
              $("input[name='check']:checked").each(function(){
                ...
                // console.log(url);return;
                 var feiedurl = "<?php  echo 'http://'.$_SERVER['SERVER_NAME'].'/feie/API_PHP_DEMO.php';?>";
                $.post(
                        url,
                        {idArr: id},
                        function (data) {
