        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
             ...
             <!--    <div class="form-group" id="is_print_all">
                    ...
                    <div class="col-sm-9">
                       ...
                       <!--  <div class="checkbox checkbox-success checkbox-inline">
                        ...
                        <div class="checkbox checkbox-success checkbox-inline">
                            ...
                            <label for="inlineCheckbox5" style="padding-left: 0px;">支持排队</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">前台打印机设备编码</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group" id="print_key">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">前台打印机API密钥</label>
                    <div class="col-sm-9">
                        <input type="text" name="feyin_key" class="form-control" value="<?php  echo $setting['feyin_key'];?>" placeholder="API密钥"/>
                    </div>
                </div>
                 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">后厨机设备编码</label>
                    <div class="col-sm-9">
                        <input type="text" name="bprint_usr" class="form-control" value="<?php  echo $setting['bprint_usr'];?>" placeholder="SN码|机器码|IMEI码"/>
                    </div>
                </div>
                <div class="form-group" id="print_key">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">后厨机API密钥</label>
                    <div class="col-sm-9">
                        <input type="text" name="bfeyin_key" class="form-control" value="<?php  echo $setting['bfeyin_key'];?>" placeholder="API密钥"/>
                    </div>
                </div>
