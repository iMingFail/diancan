...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($deleted == 1) { ?>class="active"<?php  } ?>><a
        href="<?php  echo $this->createWebUrl('stores2', array('op' => 'display', 'deleted' => 1))?>">门店回收站</a></li>
    <?php  } ?>
    <?php  } ?>
    <?php  if($operation == 'setting') { ?>
                    ...
                    <form action="<?php  echo $this->createWebUrl('stores2', array('op' => 'changeprice'))?>" method="post"
                        ...
                        <div class="form-group" style="margin-top: 10px;">
                            ...
                            <div class="col-sm-9">
                                ...
                                <button type="submit" class="btn btn-primary" onclick="return confirm('确认提交吗？');return false;">提交</button>
                            </div>
                        </div>
                    </form>
                </div>
