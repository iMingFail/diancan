<?php defined('IN_IA') or exit('Access Denied');?><div class="tab-pane  active" id="tab_basic">
   ...
   <!--  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <div class="input-group clockpicker">
                <input type="text" class="form-control" value="<?php  echo $reply['endtime1'];?>"
                       name="endtime1">
                                <span class="input-group-addon">
                                <span class="glyphicon glyphicon-time"></span>
                                </span>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <div class="input-group clockpicker">
                <input type="text" class="form-control" value="<?php  echo $reply['begintime2'];?>"
                       name="begintime2">
                                <span class="input-group-addon">
                                <span class="glyphicon glyphicon-time"></span>
                                </span>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">商家wifi</label>
        <div class="col-sm-9">
            <input type="text" name="wifi" class="form-control" value="<?php  echo $reply['wifi'];?>" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">商家wifipwd</label>
        <div class="col-sm-9">
            <input type="text" name="wifipwd" class="form-control" value="<?php  echo $reply['wifipwd'];?>" />
        </div>
    </div>
    <div class="form-group">
