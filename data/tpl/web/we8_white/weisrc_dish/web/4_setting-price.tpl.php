    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否包含配送费</label>
                <div class="col-sm-9">
                    <label for="is_contain_delivery1" class="radio-inline"><input type="radio" name="is_contain_delivery" value="1" id="is_contain_delivery1" <?php  if(empty($setting) || $setting['is_contain_delivery'] == 1) { ?>checked="true"<?php  } ?> /> 是</label>
                    &nbsp;&nbsp;&nbsp;
                    <label for="is_contain_delivery2" class="radio-inline"><input type="radio" name="is_contain_delivery" value="0" id="is_contain_delivery2"  <?php  if($setting['is_contain_delivery'] == 0) { ?>checked="true"<?php  } ?> /> 否</label>
