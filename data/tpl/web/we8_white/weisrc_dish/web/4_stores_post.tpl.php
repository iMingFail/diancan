    ...
    <form action="" method="post" onsubmit="return check();" class="form-horizontal form" enctype="multipart/form-data">
        <div class="panel panel-default">
            <div class="panel-heading">
                门店信息
                <!-- <a class="btn btn-danger btn-sm" href="#" onclick="hdurl('<?php  echo $reply['id'];?>');">商家入口</a> -->
            </div>
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <?php  include $this->template('web/stores_tab_en');?>
...
<script>
    function hdurl(id){
        $('#Modal2').modal('toggle');
        $('#tpindex').html('<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&storeid=' + id +
        '&do=mindex&m=weisrc_dish&mode=2&op=alert');
        $('#tpwaimai').html('<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&storeid=' + id + '&do=mindex&m=weisrc_dish&mode=2');
        $('#tpkuaican').html('<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&storeid=' + id + '&do=mindex&m=weisrc_dish&mode=4');
        $('#tppaihao').html('<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&storeid=' + id + '&do=queueform&m=weisrc_dish');
        $('#tpyuding').html('<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&storeid=' + id + '&do=reservationdetails&m=weisrc_dish');
