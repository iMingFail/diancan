<?php defined('IN_IA') or exit('Access Denied');?><div class="tab-pane" id="tab_link">
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">a.外链名称</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">b.外链名称</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">c.外链名称</label>
        <div class="col-sm-9">
