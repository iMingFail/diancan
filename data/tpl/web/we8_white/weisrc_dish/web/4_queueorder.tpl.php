...
<audio id="music" >
    <source src="http://tts.baidu.com/text2audio?lan=zh&ie=UTF-8&spd=3&text=A-004，A-004，请就餐？" type="audio/mpeg">
    <embed height="0" width="0" src="http://tts.baidu.com/text2audio?lan=zh&ie=UTF-8&spd=3&text=A-004，A-004，请就餐？">
</audio>
<script>
    "<?php  if(!empty($item)) { ?>"
    var i=1;
            ...
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:10%;">客人数量</th>
                        <th style="width:10%;">是否抽烟</th>
            ...
            <div class="panel-body">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="remark" class="form-control" value="<?php  echo $item['remark'];?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否抽烟</label>
                    <div class="col-sm-9" style="margin-top:7px">

                        <?php  if($item['smoke']==1) { ?>
                             <input type="radio" name="smoke" value="1" checked="">&nbsp;是&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="smoke" value="2">&nbsp;否&nbsp;&nbsp;&nbsp;
                            <?php  } ?>
                         <?php  if($item['smoke']==2) { ?>
                             <input type="radio" name="smoke" value="1" >&nbsp;是&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="smoke" value="2" >&nbsp;否&nbsp;&nbsp;&nbsp;
                            <?php  } ?>
                    </div>
                </div>
