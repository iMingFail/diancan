    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <a class="btn btn-warning"
               href="<?php  echo $this->createWebUrl('dispatchareas', array('op' => 'display', 'storeid' => $storeid))?>">返回配送区域管理
            </a>
        </div>
    </div>
            ...
            <div class="panel-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9 input-group">
                        <input type="text" name="code" class="form-control" value="<?php  echo $dispatcharea['code'];?>" />
                    </div>
                </div>
                <div class="form-group">
...
<ul class="nav nav-tabs">
    <li <?php  if($operation == 'display' || empty($operation)) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatchareas', array('op' => 'display', 'storeid' => $storeid))?>">配送区域管理</a></li>
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatchareas', array('op' => 'post', 'storeid' => $storeid))?>">添加配送区域</a></li>
</ul>
<div class="main">
    <div class="panel panel-default">
                    ...
                    <tbody id="level-list">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="displayorder[<?php  echo $row['id'];?>]" value="<?php  echo $row['displayorder'];?>"></td>
                             <td><input type="text" class="form-control" name="code[<?php  echo $row['id'];?>]" value="<?php  echo $row['code'];?>"></td>
                            <td><input type="text" class="form-control" style="width:150px;" name="goodsname[<?php  echo $row['id'];?>]" value="<?php  echo $row['title'];?>"></td>
                            <td style="text-align:right;"><a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('dispatchareas', array('op' => 'post', 'id' => $row['id'], 'storeid' => $storeid))?>" title="编辑">改</a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('dispatchareas', array('op' => 'delete', 'id' => $row['id'], 'storeid' => $storeid))?>" onclick="return confirm('确认删除此配送区域吗？');return false;" title="删除">删</a></td>
                        </tr>
                        <?php  } } ?>
                        <tr>
                            <td colspan="4">
    ...
    $(function () {
        ...
        $("input[name=btndeleteall]").click(function () {
            ...
            if (confirm("确认要删除选择的配送区域?")) {
                ...
                var url = "<?php  echo $this->createWebUrl('dispatchareas', array('op' => 'deleteall', 'storeid' => $storeid))?>";
                $.post(
                        url,
                        {idArr: id},
                        function (data) {
