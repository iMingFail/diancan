...
<div class="mui-content pay-method">
	...
	<ul class="mui-table-view mui-table-view-chevron">
		...
		<li class="mui-table-view-cell">
			...
			<a class="mui-navigate-right mui-media" style="text-decoration: none;"  href="/app/index.php?c=entry&do=xlpay&m=weisrc_dish&
				orderNum=<?php echo  $params['ordersn'];?>&
				price= <?php  echo sprintf('%.2f', $params['fee']);?>&
				id=<?php echo $_GET['id'];?>&
		...
		<li class="mui-table-view-cell">
			<a class="mui-navigate-right mui-media" href="http://<?php echo $_SERVER['SERVER_NAME'];?>/payment/xlpay/pay.php?orderNum=<?php  echo $params['ordersn'];?>">
				<img src="resource/images/wx-icon.png" alt="" class="mui-media-object mui-pull-left"/>
				<span class="mui-media-body mui-block">
					<span>微信支付(服务商)</span>
		...
		<li class="mui-table-view-cell mui-disabled">
			<a class="mui-navigate-right mui-media feie" href="javascript:void" link="http://<?php echo $_SERVER['SERVER_NAME'];?>/shop/app/index.php?c=entry&do=outline&m=weisrc_dish"  ids="<?php echo  $params['tid'];?>" style="text-decoration: none;">
				<img src="resource/images/icon-vip.png" alt="" class="mui-media-object mui-pull-left"/>
				<span class="mui-media-body mui-block">
					确认订单
					<span class="mui-block mui-text-muted mui-mt5">前台付款</span>
				</span>
			</a>
		</li>
		<?php  } ?>
	...
	$('.feie').click(function(){
		...
		$.ajax({
      		...
      		success : function(data) {
  				...
  				alert('打印成功！！！');
  				setTimeout(function(){
  			    window.location.href="./index.php?i="+data.weid+"&c=entry&mode=1&storeid="+data.storeid+"&tablesid="+data.tables+"&do=waplist&m=weisrc_dish";
