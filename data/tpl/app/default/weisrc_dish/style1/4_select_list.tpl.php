...
<div class="center">
	<header>
		<span class="pCount">共<?php  echo $num;?>人用餐<a href="<?php  echo $this->createMobileUrl('wapselect', array('storeid' => $storeid, 'from_user' => $from_user, 'mode' => $mode, 'tablesid' => $tablesid), true)?>">重选人数</a></span>
	...
	<footer class="footFix">
        <a class="btn_add" href="<?php  echo $this->createMobileUrl('waplist', array('storeid' => $storeid, 'from_user' => $from_user, 'mode' => $mode, 'tablesid' => $tablesid), true)?>" >返回列表</a>
		<a id="addToMenu" class="btn_add" href="<?php  echo $this->createMobileUrl('addtomenu', array('storeid' => $storeid, 'from_user' => $from_user, 'num' => $num, 'intelligentid' => $intelligentid, 'mode' => $mode, 'tablesid' => $tablesid), true)?>">加入菜单</a>
		<a class="btn_change" href="<?php  echo $this->createMobileUrl('wapselectlist', array('storeid' => $storeid, 'from_user' => $from_user, 'num' => $num, 'intelligentid' => $intelligentid, 'mode' => $mode, 'tablesid' => $tablesid), true)?>" onclick="showDish()">换一桌</a>
	</footer>
</div>
