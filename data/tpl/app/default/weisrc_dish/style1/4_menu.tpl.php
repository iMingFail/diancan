            ...
            <div class="address-editor-ribbon"></div>
               ...
               <!--  <li class="item-content">
                    <div class="item-inner">
                        ...
                        <div class="item-input input-address" style="padding-right:30px; line-height:21px" id="mapaddress" name="mapaddress"></div>
                        <!--<div class="item-input">-->
                ...
                <li class="item-content">
                        <div class="item-inner">
                            <div class="item-title label">收餐地址:</div>
                            <div class="item-input">
                                <input type="text" id="address" name="address" placeholder="详细地址/楼层/门牌号等信息" value="<?php  if(!empty($user['address'])) { ?><?php  echo $user['address'];?><?php  } else { ?>请输入您的详细联系地址！<?php  } ?>">
                    ...
                    <script>
                        ...
                        function creatmap() {
                            ...
                            function getGeoLocation(address) {
                                address = typeof address == 'string' ? address : $('#mapaddress').html();
