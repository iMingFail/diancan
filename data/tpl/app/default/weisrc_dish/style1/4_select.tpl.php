...
function doSelected() {
    document.getElementById('order').href = "<?php  echo $this->createMobileUrl('wapselectlist', array('storeid' => $storeid, 'mode' => $mode, 'tablesid' => $tablesid), true)?>"+'&num='+_selectedCount;
}
</script>
</body>
</html>