...
<div id="wrap1">
    ...
    <div id="header" style="background-color: #f60;">
    ...
    <div class="shop" style="background-color: #f60;">
...
<div class="main-tab3" style="margin-top:170px;overflow: scroll;height: 100%;overflow-y:scroll;-webkit-overflow-scrolling:touch;">
    ...
    <div class="detail-region" <?php  if(!empty($item['thumbs'])) { ?>style="margin-top: 5px;"<?php  } ?>>
        ...
        <div class="detail-favor">
            ...
            <div class="discountitem">
                ...
                <div class="operation-nav-item ng-scope <?php  if($item['is_delivery']!=1) { ?>inavailable<?php  } ?>">
                    ...
                    <a href="<?php  if($item['is_delivery']!=1) { ?>#<?php  } else { ?><?php  echo $this->createMobileUrl('mindex', array('storeid' => $item['id'], 'mode' => 2), true)?><?php  } ?>">
                ...
                <div class="operation-nav-item ng-scope <?php  if($item['is_snack']!=1) { ?>inavailable<?php  } ?>">
                    ...
                    <a href="<?php  if($item['is_snack']!=1) { ?>#<?php  } else { ?><?php  echo $this->createMobileUrl('mindex', array('storeid' => $item['id'], 'mode' => 4), true)?><?php  } ?>">
    ...
    <div class="detail-region" style="">
        ...
        <div class="detail-content">
            ...
            <div class="detail-phone">
                ...
                <p>电话： <a href="tel:<?php  echo $item['tel'];?>"><?php  echo $item['tel'];?> <span class="mt-delivery">拨打</span></a>
            ...
            <div class="detail-address">
                ...
                <p><a href="http://api.map.baidu.com/marker?location=<?php  echo $item['lat'];?>,<?php  echo $item['lng'];?>&title=<?php  echo $item['title'];?>&content=<?php  echo $item['address'];?>&output=html&src=wzj|wzj" ><?php  echo $item['address'];?> <span
...
<script>
    ...
    $(function() {
        ...
        $('.qualification').click(function(){
            ...
            $('.main-tab3').css({"margin-top":"170px"})
...
<link href="<?php echo RES;?>/swiper/css/swiper.min.css" rel="stylesheet">
